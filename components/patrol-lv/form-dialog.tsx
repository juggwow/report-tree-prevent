          ...
          <DialogContentText id="alert-dialog-form">
            <TextField
              ...
              defaultValue={
                defaultValOldPlan
                  ? changePlanRequire.oldPlan.peaNo
                  : changePlanRequire.newPlan.peaNo
              }
              onChange={(e) =>
                setChangePlanRequire({
                  ...changePlanRequire,
            ...
            <TextField
              ...
              defaultValue={
                defaultValOldPlan
                  ? changePlanRequire.oldPlan.feeder
                  : changePlanRequire.newPlan.feeder
              }
              onChange={(e) =>
                setChangePlanRequire({
                  ...changePlanRequire,
              ...
              error={!/^[A-Z]{3}\d{2}$/.test(changePlanRequire.newPlan.feeder)}
            ...
            <TextField
              ...
              defaultValue={
                defaultValOldPlan
                  ? changePlanRequire.oldPlan.distanceCircuit
                  : changePlanRequire.newPlan.distanceCircuit
              }
              onChange={(e) =>
                setChangePlanRequire({
                  ...changePlanRequire,
